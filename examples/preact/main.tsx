...
import { PhoneInput } from '../../src/preact';
import type { PhoneInputRef } from '../../src/preact';
...
function App() {
  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', maxWidth: 480, margin: '60px auto', padding: '0 20px' }}>
      <h1 style={{ fontSize: '1.4rem' }}>lite-phone-input — Preact</h1>

      <label for="phone" style={{ display: 'block', marginBottom: 8, fontWeight: 500 }}>
        Phone number
      </label>
